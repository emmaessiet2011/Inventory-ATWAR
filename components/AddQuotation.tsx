...
const AddQuotation: React.FC<AddQuotationProps> = ({ onNavigate }) => {
  ...
  const [saleDate, setSaleDate] = useState('2026-02-11T10:08');
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-32">
        ...
        <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-slate-900">Add Quotation</h2>
        </div>
        ...
        <div className="bg-white rounded shadow-sm border border-slate-200 p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                {/* Status for Quotation is implicit or can be added if needed, usually fixed or omitted in this view based on screenshot */}
            </div>
        ...
        <div className="fixed bottom-0 left-0 w-full bg-slate-100 border-t border-slate-200 py-4 px-8 z-40 flex justify-center gap-4">
             <button className="px-6 py-2 bg-[#6200ea] text-white font-bold rounded shadow hover:bg-[#5000ca] text-sm">Save</button>
