...
import { 
  ...
  Briefcase, Eye, FileCheck, Edit
} from 'lucide-react';
import { useNotifications } from '../src/context/NotificationContext';
import { Product, SHIPPING_STATUS_OPTIONS, ShippingStatus, useGlobalContext } from '../src/context/GlobalContext';
...
import { resolveInvoiceLayoutRenderConfig } from '../src/utils/receiptPrinting';
...
const AddSale: React.FC<AddSaleProps> = ({ onNavigate, fromOrder, isEdit, saleId, initialStatus, strictInitialStatus = false }) => {
  ...
  const getLocationScopedProducts = (): Product[] => {
    ...
    if (!normalizedLocation) return products;
    return products.filter(p => String(p.businessLocation || '').trim().toLowerCase() === normalizedLocation);
  };
