...
import { printDocument, statusBadge } from '../src/utils/printUtils';
import { appendStockLedgerEntries } from '../src/utils/stockTransfers';
...
} from '../src/utils/stockAdjustments';
...
const ListStockAdjustments: React.FC<ListStockAdjustmentsProps> = ({
  ...
  const deleteAdjustment = (adjustment: StockAdjustmentRecord) => {
    ...
    if (!window.confirm(`Delete stock adjustment ${adjustment.referenceNo}?`)) return;
