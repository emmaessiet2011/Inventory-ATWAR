...
const Categories: React.FC = () => {
  ...
  const [categories, setCategories] = useState<Category[]>([
    { id: 1, name: '--BLOCK', code: '', description: '' },
    { id: 2, name: 'Break Oil', code: '', description: '' },
    { id: 3, name: 'Dry Pet Food', code: '', description: '' },
    { id: 4, name: 'Engine Flush', code: '', description: '' },
    { id: 5, name: 'Engine oil', code: '', description: '' },
    { id: 6, name: 'Food product', code: '', description: '' },
    { id: 7, name: 'Nilcutter', code: '', description: '' },
    { id: 8, name: 'Pet Oil', code: '', description: '' },
    { id: 9, name: 'Sand (clear cat)', code: '', description: 'clear cat' },
    { id: 10, name: '--STRAIGHT', code: '', description: '' },
    { id: 11, name: 'Tyres', code: '', description: '' },
    { id: 12, name: 'Wet Pet Food', code: '', description: '' },
    { id: 13, name: 'Windshield Washer', code: '', description: '' },
    { id: 14, name: '--ZIGZAG', code: 'SP901 (10.00R20)', description: 'ZIGZAG' },
  ]);
                    ...
                    <tr key={c.id} className="hover:bg-slate-50/80 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-right align-top">
                          <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              <button onClick={() => handleDelete(c.id)} className="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors" title="Delete">
                                  <Trash2 size={14} />
                              </button>
                          </div>
                      </td>
