  ...
  const [returns] = useState<PurchaseReturn[]>([
    {
      ...
      referenceNo: 'PRT2023/0001',
      parentPurchase: 'PUR2023/0045',
      location: 'CR:1450968',
    ...
    },
    {
      ...
      referenceNo: 'PRT2023/0002',
      parentPurchase: 'PUR2023/0089',
    ...
    <div className="space-y-6 animate-fade-in pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and track items returned to suppliers.</p>
        </div>
        <button 
        ...
        >
          <Plus size={18} /> Add Purchase Return
        </button>
      </div>
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead className="bg-slate-50/80 text-slate-500 font-semibold border-b border-slate-200">
              <tr>
                ...
                <th className="px-6 py-4">Parent Purchase</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredReturns.map((r) => (
                <tr key={r.id} className="hover:bg-slate-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-slate-500">{r.parentPurchase}</td>
                  ...
                  <td className="px-6 py-4 font-bold text-slate-900">{r.totalAmount.toFixed(3)} OMR</td>
