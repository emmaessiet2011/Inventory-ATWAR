...
const PERMISSION_MODULES: PermissionGroup[] = [
    ...
    { module: 'Stock Adjustment', icon: Calculator, permissions: ['View all stock adjustments', 'View own stock adjustments', 'Add stock adjustment', 'Edit stock adjustment', 'Delete stock adjustment'] },
